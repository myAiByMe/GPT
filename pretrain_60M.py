...
class LivePlot:
    ...
    2 subplots : Train Loss | Val Loss
    """
    ...
    def save(self):
        ...
        fig.suptitle(
            f'Pretrain 60M  —  {self.total_steps:,} steps',
...
class CheckpointManager:
    ...
    def save(self, model, optimizers, scheduler, metadata):
        ...
        _arch_keys = ['vocab_size', 'embed_dim', 'num_heads', 'num_layers', 'max_seq_len', 'dropout', 'use_rope', 'use_yarn', 'yarn_scale', 'yarn_original_max_len', 'use_swiglu', 'n_kv_heads', 'use_qk_norm', 'soft_cap', 'use_flash_attn']
        cp = {
